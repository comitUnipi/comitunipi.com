              ...
              <ul class="blcok lg:flex">
                ...
                <li class="relative group">
                  ...
                  <div v-if="isDropdownOpen" class="absolute left-8 w-60 bg-white py-2 shadow-lg rounded-md">
                    <a href="/kepengurusan/ketua-dan-wakil-ketua-umum"
                      class="block px-4 py-2 text-sm hover:text-white hover:bg-blue-500 rounded-md">
                      Ketua & Wakil Ketua Umum
                    </a>
                    <a href="/kepengurusan/sekretaris"
                      class="block px-4 py-2 text-sm hover:text-white hover:bg-blue-500 rounded-md">
                      Sekretaris
                    </a>
                    <a href="/kepengurusan/bendahara"
                      class="block px-4 py-2 text-sm hover:text-white hover:bg-blue-500 rounded-md">
                      Bendahara
                    </a>
                    <a href="/kepengurusan/sdm"
                      class="block px-4 py-2 text-sm hover:text-white hover:bg-blue-500 rounded-md">
                      SDM
                    </a>
                    <a href="/kepengurusan/humas-internal"
                      class="block px-4 py-2 text-sm hover:text-white hover:bg-blue-500 rounded-md">
                      Humas Internal
                    </a>
                    <a href="/kepengurusan/humas-eksternal"
                      class="block px-4 py-2 text-sm hover:text-white hover:bg-blue-500 rounded-md">
                      Humas Eksternal
                    </a>
                    <a href="/kepengurusan/koordinator"
                      class="block px-4 py-2 text-sm hover:text-white hover:bg-blue-500 rounded-md">
                      Koordinator
                    </a>
                    <a href="/kepengurusan/prasarana"
                      class="block px-4 py-2 text-sm hover:text-white hover:bg-blue-500 rounded-md">
                      Prasarana
                    </a>
                    <a href="/kepengurusan/kominfo"
                      class="block px-4 py-2 text-sm hover:text-white hover:bg-blue-500 rounded-md">
                      Kominfo
                    </a>
          ...
          <ul class="flex flex-col py-4">
            ...
            <li class="py-2 px-4">
              ...
              <div v-if="isDropdownOpen" class="pl-6 py-2">
                <a href="/kepengurusan/ketua-dan-wakil-ketua-umum"
                  class="block text-sm py-2 hover:underline rounded-md">
                  Ketua & Wakil Ketua Umum
                </a>
