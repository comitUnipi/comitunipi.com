        ...
        <div className="w-full px-4 sm:w-1/2 lg:w-1/4">
            <div className="mb-10">
                ...
                <div className="text-center">
                    <h4 className="text-dark mb-2 text-xl font-medium">{mentor.nama}</h4>
                    <p className="mb-5 text-sm font-medium text-gray-700">{mentor.job}</p>
                    <div className="flex items-center justify-center">
                        {mentor.sosmed.map((sosmed) => (
                            <div key={sosmed.id} className="mr-3">
                                <a href={sosmed.link} target="_blank" rel="noopener noreferrer">
                                    <img src={sosmed.icon} alt="icon" className="h-6 w-6 hover:scale-110" />
                                </a>
                            </div>
                        ))}
                    </div>
