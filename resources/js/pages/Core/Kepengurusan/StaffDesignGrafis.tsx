  ...
  return (
    <>
      <Head title="Staff Design Grafis Kami Periode 2024-2025">
        ...
        <meta
          rel="canonical"
          content="https://comitunipi.com/kepengurusan/staff-design-grafis"
        />
        <meta
          name="description"
          content="Kenali staff design grafis COMIT periode 2024-2025"
        />

        <meta
          property="og:title"
          content="Staff Design Grafis Kami Periode 2024-2025 - COMIT UNIPI"
        />
        <meta
