...
export default function Kominfo() {
  return (
    <>
      <Head title="Kominfo Kami Periode 2024-2025">
        <meta name="robots" content="index, follow" />
        <meta rel="canonical" content="https://comitunipi.com/kepengurusan/kominfo" />
        <meta name="description" content="Kenali kominfo COMIT periode 2024-2025" />

        <meta property="og:title" content="Kominfo Kami Periode 2024-2025 - COMIT UNIPI" />
        <meta property="og:description" content="Kenali kominfo COMIT periode 2024-2025" />
        <meta property="og:image" content="https://comitunipi.com/images/banner.png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:url" content="https://comitunipi.com/kepengurusan/kominfo" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            '@type': 'WebPage',
            name: 'Kominfo Kami Periode 2024-2025 - COMIT UNIPI',
            url: 'https://comitunipi.com/kepengurusan/kominfo',
            mainEntity: {
              '@type': 'ItemList',
