...
import { kepengurusan } from '@/constants/kepengurusan/sekretaris';
  ...
  return (
    <>
      <Head title="Sekretaris Kami Periode 2024-2025">
        ...
        <meta
          rel="canonical"
          content="https://comitunipi.com/kepengurusan/sekretaris"
        />
        <meta
          name="description"
          content="Kenali sekretaris COMIT periode 2024-2025"
        />

        <meta
          property="og:title"
          content="Sekretaris Kami Periode 2024-2025 - COMIT UNIPI"
        />
        <meta
      ...
      <MainLayout>
        ...
        <section className="pt-20 pb-10 lg:pt-[120px] lg:pb-20">
          <div className="container mx-auto">
            <KepengurusanHeading jobdesk="Sekretaris Kami" />
