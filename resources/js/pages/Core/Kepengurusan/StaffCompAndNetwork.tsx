  ...
  return (
    <>
      <Head title="Staff Computer and Networking Kami Periode 2024-2025">
        ...
        <meta
          rel="canonical"
          content="https://comitunipi.com/kepengurusan/staff-comp-and-network"
        />
        <meta
          name="description"
          content="Kenali staff computer and networking COMIT periode 2024-2025"
        />

        <meta
          property="og:title"
          content="Staff Computer and Networking Kami Periode 2024-2025 - COMIT UNIPI"
        />
        <meta
