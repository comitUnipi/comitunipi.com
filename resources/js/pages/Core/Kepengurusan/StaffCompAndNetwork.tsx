...
export default function StaffCompAndNetwork() {
  return (
    <>
      <Head title="Staff Computer and Networking Kami Periode 2024-2025">
        <meta name="robots" content="index, follow" />
        <meta rel="canonical" content="https://comitunipi.com/kepengurusan/staff-comp-and-network" />
        <meta name="description" content="Kenali staff computer and networking COMIT periode 2024-2025" />

        <meta property="og:title" content="Staff Computer and Networking Kami Periode 2024-2025 - COMIT UNIPI" />
        <meta property="og:description" content="Kenali staff computer and networking COMIT periode 2024-2025" />
        <meta property="og:image" content="https://comitunipi.com/images/banner.png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:url" content="https://comitunipi.com/kepengurusan/staff-comp-and-network" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            '@type': 'WebPage',
            name: 'Staff Computer and Networking Kami Periode 2024-2025 - COMIT UNIPI',
            url: 'https://comitunipi.com/kepengurusan/staff-comp-and-network',
            mainEntity: {
              '@type': 'ItemList',
