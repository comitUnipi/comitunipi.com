      ...
      <Card className="border-border mx-auto w-full max-w-4xl rounded-md border shadow-md md:my-4">
        ...
        <CardContent>
          <div className="mb-4 flex flex-col items-center justify-center gap-2">
            ...
            <CardTitle className="text-primary mt-0 mb-6 text-center text-lg font-bold md:text-2xl">Formulir Pendaftaran Anggota COMIT</CardTitle>
          </div>
          <form className="flex flex-col gap-6" onSubmit={submit}>
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div className="grid gap-2">
                ...
                <Input id="npm" value={data.npm} onChange={(e) => setData('npm', e.target.value)} placeholder="NPM" required disabled={processing} />
