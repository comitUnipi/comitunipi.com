...
import { Kas, User, type BreadcrumbItem } from '@/types';
import { Head, router, useForm, usePage } from '@inertiajs/react';
import { Plus } from 'lucide-react';
import { useEffect, useState } from 'react';
import KasFilter from './components/kas-filter';
import KasForm from './components/kas-form';
            ...
            <div className="from-background to-muted/20 flex h-full flex-1 flex-col gap-4 rounded-xl bg-gradient-to-br p-3 sm:gap-6 sm:p-4 md:p-6">
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-1 md:text-base">Manajemen untuk mengelola data uang kas anggota dan pengurus.</p>
                    </div>
                    <ModalConfirm
                ...
                />
                <KasTable kas={kas} user={user} handleEdit={handleEdit} setConfirmDeleteId={setConfirmDeleteId} />
                <Pagination
