        ...
        <>
            ...
            <div className="bg-primary flex min-h-screen flex-col items-center justify-center px-4">
                <div className="bg-primary w-full max-w-md rounded-lg p-6 text-center shadow-lg">
                    ...
                    <h1 className="mb-2 text-2xl font-bold text-gray-800">403 - Unauthorized</h1>
                    <p className="mb-6 text-gray-600">You do not have permission to access this page.</p>
                    <button onClick={() => window.history.back()} className="rounded bg-gray-800 px-4 py-2 text-white transition hover:bg-gray-700">
                        Go Back
                    </button>
                </div>
            </div>
