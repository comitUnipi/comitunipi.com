...
export default function PengeluaranFilter({ startDate, endDate, setStartDate, setEndDate, handleFilterTanggal, handleResetFilter }: Props) {
  return (
    <div className="flex flex-col gap-3 sm:gap-4">
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        ...
        />
        <Input type="date" value={endDate} onChange={(e) => setEndDate(e.target.value)} placeholder="Tanggal Akhir" className="w-full sm:w-auto" />
