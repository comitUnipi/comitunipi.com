...
import { Pemasukan, User, type BreadcrumbItem } from '@/types';
import { Head, router, useForm, usePage } from '@inertiajs/react';
import { Plus } from 'lucide-react';
import { useEffect, useState } from 'react';
import PemasukanFilter from './components/pemasukan-filter';
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="from-background to-muted/20 flex h-full flex-1 flex-col gap-4 rounded-xl bg-gradient-to-br p-3 sm:gap-6 sm:p-4 md:p-6">
                ...
                />
                <PemasukanTable pemasukan={pemasukan} user={user} handleEdit={handleEdit} setConfirmDeleteId={setConfirmDeleteId} />{' '}
                <Pagination
